...
ALLOWED_HOSTS = ["115.159.226.23", "365think.cn", "www.365think.cn"]
...
MEDIA_ROOT = cur_file_dir() + '/wuqian/media/media/media/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://example.com/media/", "http://media.example.com/"
MEDIA_URL = '/wuqian/media/media/'
